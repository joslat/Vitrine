...
public static class VitrineGraphFactory
{
    ...
    private static VitrineGraphSnapshot EvaluationPlan(string name, VitrineGraphSource source) => new(
        ...
        [
            ...
            new("judged", "3 · Matched quality diagnostic", "evaluation-diagnostic",
                "Non-verdict-bearing matched Demo01 and Demo02 quality diagnostic in the credential-free offline suite. It remains visible evidence but cannot fail the suite. Paid Eval01–Eval06 plans use their own runtime graph."),
            ...
            new("controls", "43-control panel", "evaluation-controls",
                "Aggregate node for the exact registered mutation-control panel; its ×N count is the number of completed mutation-control results."),
